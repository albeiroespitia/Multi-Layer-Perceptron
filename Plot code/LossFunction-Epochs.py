...
clf = MLPClassifier(solver= 'sgd',activation = 'tanh',max_iter= 200,random_state=42,hidden_layer_sizes=15,alpha= 0.01,learning_rate_init = 0.001,batch_size=200,learning_rate='constant',shuffle= True,momentum=0.9)
...
plt.title('Loss function over epochs', fontsize=20)
