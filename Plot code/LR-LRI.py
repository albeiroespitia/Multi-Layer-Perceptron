...
learning_rate_init = [0.001,0.002,0.004,0.005,0.009]
...
def plot_grid_search(cv_results, grid_param_1, grid_param_2, name_param_1, name_param_2):
    ...
    ax.set_title("Learning Ratio Initial - Learning Rate", fontsize=20)
    ax.set_xlabel(name_param_1, fontsize=16)
    ax.set_ylabel('CV Average Score', fontsize=16)
    ax.legend(loc="best", fontsize=15)
    ax.grid('on')

plot_grid_search(grid_search.cv_results_, learning_rate_init, learning_rate, 'Learning Ratio Initial', 'Learning Rate')
plt.show()
